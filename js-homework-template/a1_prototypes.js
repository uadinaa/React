function runA1() {
    ...
    Rectangle.prototype.constructor = Rectangle //он типа смотрит на шейп и надо перевести внимание на ректангл
    ...
    Square.prototype.describe = function () {
        return Rectangle.prototype.describe.call(this) + "and Square side=" + this.side;
    };
